    ...
    <div class="row">
        ...
        <div col="col-md-3 col-xs-3">
            <div style="position: relative; left: 900px; top: 50px;" >
                <div style="height: 25px; width: 25px; background-color: #B4FFFA; border-radius: 9px; position: relative; top: 25px; right: 30px;">
                    <a href="/"><div style="position: relative; left: 5px; top: 4px" class="glyphicon glyphicon-align-justify"></div></a>
                </div>
                <div style="height: 25px; width: 25px; border-radius: 9px;">
